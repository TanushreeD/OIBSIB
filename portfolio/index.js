...
gsap.from(".heroine h3", { opacity: 0, duration: 1, delay: 1.4, y: -50 });
gsap.from(".heroine h1", { opacity: 0, duration: 1, delay: 1.7, y: -45 });
gsap.from(".heroine h4", { opacity: 0, duration: 1, delay: 2.1, y: -30 });
gsap.from(".heroine a", { opacity: 0, duration: 1, delay: 2.4, y: -10 });
